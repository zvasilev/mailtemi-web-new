...
draft: false
---
<Changelog date="v3.2.7 (Feb 26, 2026)">
  <Badge type="added">added</Badge>

  - Pinch-to-zoom: pinch or double-tap to zoom into small text, receipts, and dense tables. Horizontal panning works while zoomed.
  - Enhanced dark mode: emails with their own dark CSS are detected and left untouched. Only emails that lack dark support get targeted color adjustments. No more double-darkening or fighting with the sender's styling.
  - Markdown view: toggle between the original HTML and a distraction-free markdown view. Strips away newsletter layouts, leaving just text, headings, and links.
  - Faster content display: email content appears instantly.
</Changelog>

<Changelog date="v3.2.6 (Feb 15, 2026)">
  <Badge type="changed">changed</Badge>

  - Improved HTML-to-Markdown email rendering
  - Animated read/unread transitions in mail list
  - iPad list selection styling improvements
  - Fix compose editor not expanding when typing
  - Redesigned section headers
  - Other bug fixes and improvements
</Changelog>

<Changelog date="v3.2.5 (Jan 19, 2026)">
  <Badge type="added">added</Badge>

  **JMAP Contacts**
  - Contact sync with offline editing support
  - Conflict-free local changes
  - Android contacts UI

  <Badge type="changed">changed</Badge>

  - Resolve crash during network service shutdown
  - Better network retry for transient errors
  </Changelog>

<Changelog date="v3.2.4 (Nov 5, 2025)">
  <Badge type="added">added</Badge>

  **Updated Just Now**
  - Backend-driven sync status across iOS and Android
  - Sync indicator visible in navigation bar
  - Subtle dots animation replaces platform spinners
  - Silent handling of transient network issues

  <Badge type="changed">changed</Badge>

  - Better JMAP error descriptions
  - Empty attachments no longer re-download repeatedly
  - OAuth cancel responds faster
  </Changelog>
