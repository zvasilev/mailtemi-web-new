---
title: (Upcoming release) Automatic Email Configuration
...
- **DNS SRV Record:** Mailtemi begins by searching for a DNS SRV record (e.g., `jmap._tcp.example.com`) to locate the JMAP service.
